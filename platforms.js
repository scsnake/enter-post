...
(function () {
  const PLATFORMS = [
    ...
    },
    {
      id: 'mastodon',
      label: 'Mastodon',
      hosts: ['mastodon.social', 'mastodon.online', 'mstdn.social', 'mas.to', 'mastodon.world', 'mstdn.jp', 'pawoo.net'],
      nativeSend: 'Ctrl+Enter',
    ...
    },
    {
      ...
      nativeSend: 'Enter',
      composerSelector: '[role="textbox"][contenteditable="true"], [aria-label*="comment" i][contenteditable="true"], [aria-label*="reply" i][contenteditable="true"]',
    ...
    },
    {
      ...
      nativeSend: 'Enter',
      composerSelector: 'textarea[aria-label*="comment" i], textarea[aria-label*="reply" i], textarea[aria-label*="message" i], [role="textbox"][contenteditable="true"]',
    ...
    },
    {
      ...
      nativeSend: 'Enter',
      composerSelector: '[data-e2e="comment-input"] [contenteditable="true"], [data-e2e="reply-input"] [contenteditable="true"], [data-e2e*="comment" i] [contenteditable="true"], div[contenteditable="plaintext-only"]',
      sendButtonSelector: '[data-e2e="comment-post"], [data-e2e="reply-post"]',
      insertNewline: 'contenteditable',
    },
    {
      id: 'discord',
    ...
    },
    {
      id: 'line',
      label: 'LINE',
      hosts: ['line.me', 'web.line.me', 'chat.line.biz'],
      nativeSend: 'Enter',
      composerSelector: '[contenteditable="true"][role="textbox"], textarea[data-testid="chat-input"], textarea.message-input',
      sendButtonSelector: 'button[aria-label*="送信"], button[aria-label*="Send" i], button[data-testid*="send" i]',
      insertNewline: 'contenteditable',
    },
    {
      id: 'niconico',
      label: 'Niconico',
      hosts: ['nicovideo.jp', 'www.nicovideo.jp', 'live.nicovideo.jp', 'live2.nicovideo.jp'],
      nativeSend: 'Enter',
      composerSelector: 'textarea[data-testid="comment-form-input"], textarea.CommentForm-input, textarea[name="comment"], input[type="text"][name="comment"]',
      sendButtonSelector: 'button[data-testid="comment-form-submit"], button.CommentForm-submit, button[type="submit"]',
      insertNewline: 'textarea',
    },
    {
      id: 'note',
      ...
      hosts: ['note.com'],
      nativeSend: 'Ctrl+Enter',
      composerSelector: '.ProseMirror, [contenteditable="true"][role="textbox"], textarea[name="comment"]',
      sendButtonSelector: 'button[type="submit"], button[data-testid*="submit" i]',
      insertNewline: 'contenteditable',
    },
    {
      id: 'qiita',
      ...
      hosts: ['qiita.com'],
      nativeSend: 'Ctrl+Enter',
      composerSelector: 'textarea[name="comment[body]"], textarea[name="reply[body]"], textarea.editor__textarea, .ProseMirror',
    ...
    },
    {
      ...
      hosts: ['zenn.dev'],
      nativeSend: 'Ctrl+Enter',
      composerSelector: 'textarea[name="body"], textarea[name="content"], textarea[class*="CommentForm" i], textarea[class*="Comment_" i], .ProseMirror',
      sendButtonSelector: 'button[type="submit"]',
      insertNewline: 'textarea',
    },
    {
      id: 'chatwork',
      label: 'Chatwork',
      hosts: ['chatwork.com', 'www.chatwork.com'],
      nativeSend: 'Enter',
      composerSelector: 'textarea#_chatText, textarea[data-testid="timeline_chat_text"], textarea[name="chatText"]',
      sendButtonSelector: 'button[data-testid="timeline_send-message-button"], button#_sendButton',
      insertNewline: 'textarea',
    },
  ];
