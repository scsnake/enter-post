...
(function () {
  const PLATFORMS = [
    ...
    },
    {
      ...
      hosts: ['qiita.com'],
      nativeSend: 'Ctrl+Enter',
      composerSelector: 'textarea[name="comment[body]"], textarea.editor__textarea, .ProseMirror, textarea',
    ...
    },
    {
      ...
      hosts: ['zenn.dev'],
      nativeSend: 'Ctrl+Enter',
      composerSelector: 'textarea[name="body"], textarea.CommentForm_textarea__, .ProseMirror, textarea',
      sendButtonSelector: 'button[type="submit"]',
      insertNewline: 'textarea',
    },
    {
